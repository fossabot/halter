...
from src.core.utils import emoji_str_cancat
        ...
        self.appbar = ft.AppBar(
            ...
            actions=[
                ft.PopupMenuButton(
                    items=[
                        ft.PopupMenuItem(
                            text="New", on_click=lambda e: print("New clicked")
                        ),
                        ft.PopupMenuItem(
                            text="Open",
...
class AppNavigationDrawer:
    def __init__(
        self, page: ft.Page, container: ft.Container, views: list[ft.Control]
    ) -> None:
        self.page: ft.Page = page
        ...
        self.controls: list[ft.Control] = [
            ft.NavigationDrawerDestination(
                icon=ft.Icons.HOME, label="Overview"
            ),
            ft.NavigationDrawerDestination(
                icon=ft.Icons.NETWORK_CELL, label="Network"
            ),
            ft.NavigationDrawerDestination(
